  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        'button-glow': {
          '0%, 100%': { boxShadow: '0 0 10px hsl(var(--primary)), 0 0 20px hsl(var(--accent)), inset 0 0 5px hsl(var(--primary))' },
          '50%': { boxShadow: '0 0 20px hsl(var(--primary)), 0 0 40px hsl(var(--accent)), inset 0 0 10px hsl(var(--primary))' },
        },
        'float': {
