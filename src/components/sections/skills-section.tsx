...
const SkillsSection = () => {
  return (
    <section id="skills" className="py-24 md:py-32 animate-scroll-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {skills.map((skill, index) => (
          <Card key={skill.name} className="bg-card/50 backdrop-blur-sm border-border animate-scroll-in" style={{ animationDelay: `${index * 0.1}s` }}>
